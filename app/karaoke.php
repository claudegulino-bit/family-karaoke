...
<div class="kar-wrap">
  ...
  <div id="karaoke-page">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center">
      ...
      <button type="button" onclick="karQToggle()" id="kar-q-btn" title="The singing queue — who sings next, in order" class="kar-tile" style="appearance:none;-webkit-appearance:none;font-family:inherit;background:#1e293b;border:1px solid rgba(210,173,108,.45);color:#D2AD6C;cursor:pointer;display:inline-flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;width:74px;height:50px;padding:4px 5px;border-radius:10px;transition:background .12s,border-color .12s,box-shadow .12s"><span style="font-size:16px;line-height:1">🎶 <span id="kar-q-count" style="font-size:11px;font-weight:700;opacity:.85;vertical-align:2px">0</span></span><span style="font-size:10.5px;font-weight:700;line-height:1.15;text-align:center">Singing Queue</span></button>
      <button type="button" onclick="karDlToggle()" id="kar-dl-btn" title="Search YouTube from here and download songs into the library" class="kar-tile" style="appearance:none;-webkit-appearance:none;font-family:inherit;background:#EF4444;border:1px solid #EF4444;color:#fff;cursor:pointer;display:inline-flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;width:74px;height:50px;padding:4px 5px;border-radius:10px;transition:background .12s,border-color .12s,box-shadow .12s"><span style="font-size:16px;line-height:1">▶</span><span style="font-size:10.5px;font-weight:700;line-height:1.15;text-align:center">YouTube Downloads</span></button>
      <button type="button" onclick="karQrToggle()" id="kar-qr-btn" title="The code guests scan to request or bring songs from their own phones" class="kar-tile" style="appearance:none;-webkit-appearance:none;font-family:inherit;background:#1e293b;border:1px solid rgba(192,132,252,.45);color:#c084fc;cursor:pointer;display:inline-flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;width:74px;height:50px;padding:4px 5px;border-radius:10px;transition:background .12s,border-color .12s,box-shadow .12s"><span style="font-size:16px;line-height:1">📱</span><span style="font-size:10.5px;font-weight:700;line-height:1.15;text-align:center">Guest QR</span></button>
      <button type="button" onclick="location.reload()" title="Reload the song lists from the server (after a download or rename)" class="kar-tile" style="appearance:none;-webkit-appearance:none;font-family:inherit;background:#1e293b;border:1px solid #334155;color:#94a3b8;cursor:pointer;display:inline-flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;width:74px;height:50px;padding:4px 5px;border-radius:10px;transition:background .12s,border-color .12s,box-shadow .12s"><span style="font-size:16px;line-height:1">🔄</span><span style="font-size:10.5px;font-weight:700;line-height:1.15;text-align:center">Refresh</span></button>
      <button type="button" onclick="karGuideToggle()" id="kar-guide-btn" title="How everything on this page works — all the rules in one readable place" class="kar-tile" style="appearance:none;-webkit-appearance:none;font-family:inherit;background:#1e293b;border:1px solid #334155;color:#94a3b8;cursor:pointer;display:inline-flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;width:74px;height:50px;padding:4px 5px;border-radius:10px;transition:background .12s,border-color .12s,box-shadow .12s"><span style="font-size:16px;line-height:1">📖</span><span style="font-size:10.5px;font-weight:700;line-height:1.15;text-align:center">Guide</span></button>
    </div>
