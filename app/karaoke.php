...
<div class="kar-wrap">
  ...
  <div id="karaoke-page">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center">
      ...
      <button type="button" onclick="location.reload()" title="Reload the song lists from the server (after a download or rename)" class="kar-tile" style="appearance:none;-webkit-appearance:none;font-family:inherit;position:relative;background:#0ea5e9;border:1px solid #0ea5e9;color:#fff;cursor:pointer;display:inline-flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;width:78px;height:56px;padding:4px 5px;border-radius:11px;transition:background .12s,border-color .12s,box-shadow .12s"><span style="font-size:23px;line-height:1">🔄</span><span style="font-size:10.5px;font-weight:800;line-height:1.15;text-align:center">Refresh</span></button>
